...
class ShiftData
{
    public function __construct(
        ...
        public int $overtimeBeforeShiftMinMinutes = 0,
        public bool $overtimeAfterShiftEnabled = true,
    ...
    public function toArray(): array
    {
        return [
            ...
            'break_as_overtime_enabled' => $this->breakAsOvertimeEnabled,
            ...
            'overtime_before_shift_min_minutes' => $this->overtimeBeforeShiftMinMinutes,
            'overtime_after_shift_enabled' => $this->overtimeAfterShiftEnabled,
