<div class="container-fluid py-4 bg-gray-200">
    <div class="row">
        <div class="col-lg-8 col-md-10 col-12 m-auto text-center">
            <h3 class="mt-3 mb-0">Thêm nhân viên hàng loạt</h3>
            <h5 class="font-weight-normal opacity-6">
                Dùng wizard 3 bước để hướng dẫn tải file, xem trước dữ liệu và nhập vào hệ thống.
            </h5>
