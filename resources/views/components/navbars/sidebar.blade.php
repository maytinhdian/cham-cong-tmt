        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#deviceExamples"
                    class="nav-link text-white {{ in_array(Route::currentRouteName(), ['attendance-devices', 'attendance-device-user-mappings', 'attendance-raw-logs', 'attendance-process-logs', 'attendance-tabulator-demo']) ? 'active' : '' }}"
                ...
                <div class="collapse {{ in_array(Route::currentRouteName(), ['attendance-devices', 'attendance-device-user-mappings', 'attendance-raw-logs', 'attendance-process-logs', 'attendance-tabulator-demo']) ? 'show' : '' }}"
                    id="deviceExamples">
                    <ul class="nav">
