...
<div class="container {{ in_array(request()->route()->getName(),['illustration-sign-up','illustration-sign-in','illustration-reset','illustration-verification','illustration-lock','cover-lock','cover-sign-up']) ? 'ps-2 pe-0' : '' }}">
    ...
    <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 d-flex flex-column {{ in_array(request()->route()->getName(),['illustration-sign-up','illustration-sign-in','illustration-reset','illustration-verification','illustration-lock']) ? '' : 'text-white' }}" href="{{ route('analytics') }}">
    ...
    <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
        <ul class="navbar-nav navbar-nav-hover mx-auto">
            ...
            <li class="nav-item dropdown dropdown-hover mx-2">
                <a role="button" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center"
                    ...
                    Pages
                    <img src=" {{ asset('assets') }}/img/down-arrow-{{ in_array(request()->route()->getName(),['illustration-sign-up','illustration-sign-in','illustration-reset','illustration-verification','illustration-lock']) ? 'dark' : 'white' }}.svg  " alt="down-arrow"
                        ...
                        <div class="col-12 px-4 py-2">
                            <div class="row">
                                <div class="col-4 position-relative">
                                    ...
                                    <a href="{{ route('analytics') }}" class="dropdown-item border-radius-md">
                ...
                <div class="dropdown-menu dropdown-menu-animation dropdown-md border-radius-xl p-3 mt-0 mt-lg-3"
                            ...
                            <ul class="list-group">
                                ...
                                <li
                                    ...
                                    <div class="dropdown-menu mt-0 py-3 px-2" aria-labelledby="dropdownError">
                                        <a class="dropdown-item ps-3 border-radius-md mb-1" href="{{ route('error404') }}">
                                            <span>404</span>
                                        </a>
                                        <a class="dropdown-item ps-3 border-radius-md" href="{{ route('error500') }}">
                                            <span>500</span>
                                        </a>
                                    </div>
                                </li>
                    ...
                    <div class="row d-lg-none">
                        <div class="col-12 d-flex justify-content-center flex-column">
                           ...
                           <a href="{{ route('error404') }}" class="dropdown-item border-radius-md ps-4">
                                404
                            </a>
                            <a href="{{ route('error500') }}" class="dropdown-item border-radius-md ps-4">
                                500
                            </a>
                        </div>
                    </div>
            ...
            <li class="nav-item dropdown dropdown-hover mx-2">
                <a role="button" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center"
                    ...
                    Applications
                    <img src=" {{ asset('assets') }}/img/down-arrow-{{ in_array(request()->route()->getName(),['pricing-page','basic-lock', 'basic-reset', 'basic-sign-in', 'basic-sign-up','basic-verification', 'cover-lock','cover-reset','cover-sign-in','cover-sign-up','cover-verification','error404','error500','register','login']) ? 'white' : 'dark'  }}.svg " alt="down-arrow"
                        class="arrow ms-1 d-lg-block d-none">
                    <img src="{{ asset('assets') }}/img/down-arrow-dark.svg" alt="down-arrow"
                        class="arrow ms-1 d-lg-none d-block">
                </a>
        ...
        <ul class="navbar-nav d-lg-block d-none">
            <li class="nav-item">
                <a href="https://www.creative-tim.com/product/material-dashboard-pro-laravel-livewire"
                    class="btn btn-sm  {{ in_array(request()->route()->getName(), ['pricing-page','basic-lock', 'basic-reset','basic-verification','cover-reset','cover-sign-in','error404','error500','forget-password']) ? 'bg-gradient-light' : '' }} {{ in_array(request()->route()->getName(), ['basic-sign-in', 'cover-lock','illustration-sign-in','cover-sign-up','illustration-sign-up','login','reset-password']) ? 'bg-gradient-primary' : '' }} {{ in_array(request()->route()->getName(), ['illustration-reset']) ? 'bg-gradient-info' : '' }} {{ in_array(request()->route()->getName(), ['cover-verification','illustration-verification']) ? 'bg-gradient-warning' : '' }} {{ in_array(request()->route()->getName(), ['illustration-lock']) ? 'bg-gradient-dark' : 'btn-success' }}  mb-0" target="_blank">Buy Now</a>
            </li>
        </ul>
    </div>
</div>
